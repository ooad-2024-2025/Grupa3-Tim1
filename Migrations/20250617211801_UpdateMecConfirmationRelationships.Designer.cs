...
namespace Matchletic.Migrations
{
    ...
    [Migration("20250617211801_UpdateMecConfirmationRelationships")]
    partial class UpdateMecConfirmationRelationships
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Matchletic.Models.KorisnikPostignuce", b =>
                {
                    b.Property<int>("KorisnikPostignuceID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("KorisnikPostignuceID"));
                    ...
                    b.Property<int>("NapredakProcenti")
                        .HasColumnType("int");

                    b.Property<int>("PostignuceID")
                        .HasColumnType("int");

                    b.HasKey("KorisnikPostignuceID");

                    b.HasIndex("KorisnikID");

                    b.HasIndex("PostignuceID");

                    b.ToTable("KorisnikPostignuca");
                });
            ...
            modelBuilder.Entity("Matchletic.Models.MecConfirmation", b =>
                {
                    b.Property<int>("MecConfirmationID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("MecConfirmationID"));
                    ...
                    b.HasKey("MecConfirmationID");

                    b.HasIndex("KorisnikID");

                    b.HasIndex("MecID");

                    b.ToTable("MecConfirmations");
                });
            ...
            modelBuilder.Entity("Matchletic.Models.MecRequest", b =>
                {
                    b.Property<int>("MecRequestID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("MecRequestID"));
                    ...
                    b.HasKey("MecRequestID");

                    b.HasIndex("KorisnikID");

                    b.HasIndex("MecID");

                    b.ToTable("MecRequests");
                });

            modelBuilder.Entity("Matchletic.Models.Notifikacija", b =>
                {
                    ...
                    b.Property<string>("PodaciZahtjeva")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Matchletic.Models.Postignuce", b =>
                {
                    b.Property<int>("PostignuceID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("PostignuceID"));

                    b.Property<string>("BojaKlasa")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Matchletic.Models.KorisnikPostignuce", b =>
                {
                    b.HasOne("Matchletic.Models.Korisnik", "Korisnik")
                        .WithMany("KorisnickaPostignuca")
                        .HasForeignKey("KorisnikID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Matchletic.Models.Postignuce", "Postignuce")
                        .WithMany("KorisniciPostignuca")
                        .HasForeignKey("PostignuceID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Korisnik");

                    b.Navigation("Postignuce");
                });
            ...
            modelBuilder.Entity("Matchletic.Models.Korisnik", b =>
                {
                    b.Navigation("KorisnickaPostignuca");
            ...
            modelBuilder.Entity("Matchletic.Models.Postignuce", b =>
                {
                    b.Navigation("KorisniciPostignuca");
                });
