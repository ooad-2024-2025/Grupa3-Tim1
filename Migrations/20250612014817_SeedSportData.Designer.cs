...
namespace Matchletic.Migrations
{
    ...
    [Migration("20250612014817_SeedSportData")]
    partial class SeedSportData
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Matchletic.Models.Oglas", b =>
                {
                    b.Property<int>("OglasID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Matchletic.Models.OglasKorisnik", b =>
                {
                    b.Property<int>("OglasKorisnikID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("OglasKorisnikID"));
                    ...
                    b.HasKey("OglasKorisnikID");

                    b.HasIndex("KorisnikID");

                    b.HasIndex("OglasID");

                    b.ToTable("OglasiKorisnici");
                });
            ...
            modelBuilder.Entity("Matchletic.Models.Mec", b =>
                {
                    b.HasOne("Matchletic.Models.Oglas", "Oglas")
                        .WithMany("Mecevi")
            ...
            modelBuilder.Entity("Matchletic.Models.OglasKorisnik", b =>
                {
                    b.HasOne("Matchletic.Models.Korisnik", "Korisnik")
                        .WithMany("OglasiKorisnika")
                        .HasForeignKey("KorisnikID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Matchletic.Models.Oglas", "Oglas")
                        .WithMany("KorisniciOglasa")
                        .HasForeignKey("OglasID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
